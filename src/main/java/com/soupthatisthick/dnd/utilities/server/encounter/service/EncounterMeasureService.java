...
import com.soupthatisthick.dnd.utilities.server.encounter.model.*;
import com.soupthatisthick.dnd.utilities.server.encounter.repo.CrRepository;
import com.soupthatisthick.dnd.utilities.server.encounter.repo.LevelRepository;
...
//			ChallengeRating crEntity = crRepository.findByValue(cr);
//			if (crEntity==null) {
...
//			Level level = levelRepository.findByLevel(allyLevel);
//			if (level==null) {
//				throw new ServiceException(ErrorCode.UNKNOWN_ERROR, "No thresholds defined for ally level " + allyLevel + ".");
//			}
//			partyEasy += level.getEasy();
//			partyModerate += level.getNormal();
//			partyHard += level.getHard();
//			partyDeadly += level.getDeadly();
//		}
//
//		int sumEnemyXp = 0;
